...
train_data_path = './data/pl/aug/'
test_data_path = './data/pl/test/'
...
train_data = {
    ...
    'datasets': [
        {
            'files': train_data_path + 'pl.train.text',
            'vocab_file': test_data_path + 'vocab',
            'data_name': ''
        },
        {
            'files': train_data_path + 'pl.train.labels',
            'data_type': 'int',
            'data_name': 'labels'
        }
    ],
...
val_data['datasets'][0]['files'] = train_data_path + 'pl.dev.text'
val_data['datasets'][1]['files'] = train_data_path + 'pl.dev.labels'

test_data = copy.deepcopy(train_data)
test_data['datasets'][0]['files'] = test_data_path + 'pl.test.text'
test_data['datasets'][1]['files'] = test_data_path + 'pl.test.labels'
