...
train_data_path = './data/ypd/aug/'
test_data_path = './data/ypd/test/'

exp_path = './results/ypd/aug/'
...
train_data = {
    ...
    'datasets': [
        {
            'files': train_data_path + 'sentiment.train.text',
            'vocab_file': test_data_path + 'vocab',
            'data_name': ''
        },
        {
            'files': train_data_path + 'sentiment.train.labels',
            'data_type': 'int',
            'data_name': 'labels'
        }
    ],
...
val_data['datasets'][0]['files'] = train_data_path + 'sentiment.dev.text'
val_data['datasets'][1]['files'] = train_data_path + 'sentiment.dev.labels'

test_data = copy.deepcopy(train_data)
test_data['datasets'][0]['files'] = test_data_path + 'test.text'
test_data['datasets'][1]['files'] = test_data_path + 'test.labels'
